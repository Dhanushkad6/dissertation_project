...
#check for missing value count for each column
...
#Adding new column and assigning a default value = 'Yes'
...
#remove columns completed_on_time, completed_on_budget and requirement_satisfaction
...
software_project_data <- as.data.frame(unclass(software_project_data),stringsAsFactors=TRUE)
str(software_project_data)

#convert successful column to factor
software_project_data$successful <- as.factor(software_project_data$successful)
str(software_project_data$successful)